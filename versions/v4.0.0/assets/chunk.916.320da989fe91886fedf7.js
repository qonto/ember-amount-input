...
function ce(){var e,t
e=T.now(),L.depth=(L.depth||0)+1,function e(t){if(le.length&&!L.blocking){var n=T.now()-t
if(!g||L.updateRate<=0||n<L.updateRate){var r=le.shift()
oe.resolve(r()).then((function(){le.length?e(t):ce()}))}else g(ce)}}(e),L.depth--,le.length||L.blocking||L.current||(L.blocking||L.queue.length||0!==L.depth?(t=L.queue.shift()(),le.push.apply(le,l(t)),ue>0&&ue--,ce()):function(){var e
if(0===L.stats.testCount&&!0===L.failOnZeroTests)return e=L.filter&&L.filter.length?new Error('No tests matched the filter "'.concat(L.filter,'".')):L.module&&L.module.length?new Error('No tests matched the module "'.concat(L.module,'".')):L.moduleId&&L.moduleId.length?new Error('No tests matched the moduleId "'.concat(L.moduleId,'".')):L.testId&&L.testId.length?new Error('No tests matched the testId "'.concat(L.testId,'".')):new Error("No tests were run."),ye("global failure",q((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void ce()
var t=L.storage,n=Math.round(T.now()-L.started),r=L.stats.all-L.stats.bad
fe.finished=!0,ne("runEnd",F.end(!0)),se("done",{passed:r,failed:L.stats.bad,total:L.stats.all,runtime:n}).then((function(){if(t&&0===L.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}var fe={finished:!1,add:function(e,t,n){if(t)L.queue.splice(ue++,0,e)
...
L.queue.splice(ue+r,0,e)}else L.queue.push(e)},advance:ce,taskCount:function(){return le.length}},de=function(){function e(t,n,r){o(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return a(e,[{key:"start",value:function(e){return e&&(this._startTime=T.now(),T.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=T.now(),T)){T.mark("qunit_test_end")
...
function he(e){if(this.expected=null,this.assertions=[],this.module=L.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new k,this.nextPauseId=1,this.stackOffset=3,q(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),fe.finished)w.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
else{if(!this.skip&&"function"!=typeof this.callback){var t=this.todo?"QUnit.todo":"QUnit.test"
throw new TypeError("You must provide a callback to ".concat(t,'("').concat(this.testName,'")'))}++he.count,this.errorForStack=new Error,this.callback&&this.callback.validTest&&(this.errorForStack.stack=void 0),this.testReport=new de(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()})
for(var n=0,r=this.module.tests;n<r.length;n++)this.module.tests[n].name===this.testName&&(this.testName+=" ")
this.testId=_(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new Z(this)}}function pe(){if(!L.current)throw new Error("pushFailure() assertion outside test context, in "+V(2))
var e=L.current
return e.pushFailure.apply(e,arguments)}function ge(){if(L.pollution=[],L.noglobals)for(var e in d)if(E.call(d,e)){if(/^qunit-test-output/.test(e))continue
L.pollution.push(e)}}he.count=0,he.prototype={get stack(){return J(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t),r=oe.resolve()
return n.forEach((function(e){r=r.then((function(){return e.stats={all:0,bad:0,started:T.now()},ne("suiteStart",e.suiteReport.start(!0)),se("moduleStart",{name:e.name,tests:e.tests})}))})),r.then((function(){return L.current=e,e.testEnvironment=q({},t.testEnvironment),e.started=T.now(),ne("testStart",e.testReport.start(!0)),se("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){L.pollution||ge()}))}))},run:function(){if(L.current=this,L.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,J(e,0)),ge(),L.blocking&&xe(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&pe("Test did not finish synchronously even though assert.timeout( 0 ) was used.",V(2))}},after:function(){!function(){var e=L.pollution
ge()
var t=M(L.pollution,e)
t.length>0&&pe("Introduced global variable(s): "+t.join(", "))
var n=M(e,L.pollution)
n.length>0&&pe("Deleted global variable(s): "+n.join(", "))}()},queueGlobalHook:function(e,t){var n=this
...
r.preserveEnvironment=!0}if("after"!==t||function(e){return e.testsRun===Ce(e).filter((function(e){return!e.skip})).length-1}(n)||!(L.queue.length>0||fe.taskCount()>2))if(L.current=r,L.notrycatch)i()
...
i?Me(t):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(t),a&&(s?a.setItem("qunit-test-"+n+"-"+r,s):a.removeItem("qunit-test-"+n+"-"+r)),ne("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var c=this
return se("testDone",{name:r,module:n,skipped:i,todo:o,failed:s,passed:this.assertions.length-s,total:this.assertions.length,runtime:i?0:this.runtime,assertions:this.assertions,testId:this.testId,get source(){return c.stack}}).then((function(){if(Te(t)){for(var e=[t],n=t.parentModule;n&&Te(n);)e.push(n),n=n.parentModule
var r=oe.resolve()
...
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof he))throw new Error("pushFailure() assertion outside test context, was "+V(2))
...
i.remaining--,0===i.remaining&&n.pauses.delete(r),Ee(n)}}return n.pauses.set(r,i),g&&("number"==typeof n.timeout?t=n.timeout:"number"==typeof L.testTimeout&&(t=L.testTimeout),"number"==typeof t&&t>0&&(L.timeoutHandler=function(e){return function(){L.timeout=null,i.cancelled=!0,n.pauses.delete(r),n.pushFailure("Test took longer than ".concat(e,"ms; test timed out."),V(2)),Ee(n)}},m(L.timeout),L.timeout=g(L.timeoutHandler(t),t))),o},resolvePromise:function(e,t){if(null!=e){var n=this,r=e.then
...
n.pushFailure(r,J(e,0)),ge(),xe(n)}))}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
...
var me=!1
function ve(e){me||L.currentModule.ignored||new he(e).queue()}function be(e){L.currentModule.ignored||(me||(L.queue.length=0,me=!0),new he(e).queue())}function ye(e,t){ve({testName:e,callback:t})}function ke(e,t){return"".concat(e," [").concat(t,"]")}function we(e,t){if(Array.isArray(e))for(var n=0;n<e.length;n++)t(e[n],n)
else{if("object"!==i(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(i(e)," instead."))
for(var r in e)t(e[r],r)}}function xe(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Ee(e)}function Ee(e){e.pauses.size>0||(g?(m(L.timeout),L.timeout=g((function(){e.pauses.size>0||(m(L.timeout),L.timeout=null,L.blocking=!1,fe.advance())}))):(L.blocking=!1,fe.advance()))}function Ce(e){for(var t=[].concat(e.tests),n=l(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,l(r.childModules))}return t}function Te(e){return e.testsRun+e.testsIgnored===Ce(e).length}function Me(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}q(ye,{todo:function(e,t){ve({testName:e,callback:t,todo:!0})},skip:function(e){ve({testName:e,skip:!0})},only:function(e,t){be({testName:e,callback:t})},each:function(e,t,n){we(t,(function(t,r){ve({testName:ke(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}}),ye.todo.each=function(e,t,n){we(t,(function(t,r){ve({testName:ke(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})}))},ye.skip.each=function(e,t){we(t,(function(t,n){ve({testName:ke(e,n),stackOffset:5,skip:!0})}))},ye.only.each=function(e,t,n){we(t,(function(t,r){be({testName:ke(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}
var Se,Ne,je,qe,Ie=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
if("undefined"!=typeof process){var _e=process.env
Se=_e.FORCE_COLOR,Ne=_e.NODE_DISABLE_COLORS,je=_e.NO_COLOR,qe=_e.TERM,Re=process.stdout&&process.stdout.isTTY}var Oe={enabled:!Ne&&null==je&&"dumb"!==qe&&(null!=Se&&"0"!==Se||Re),reset:Le(0,0),bold:Le(1,22),dim:Le(2,22),italic:Le(3,23),underline:Le(4,24),inverse:Le(7,27),hidden:Le(8,28),strikethrough:Le(9,29),black:Le(30,39),red:Le(31,39),green:Le(32,39),yellow:Le(33,39),blue:Le(34,39),magenta:Le(35,39),cyan:Le(36,39),white:Le(37,39),gray:Le(90,39),grey:Le(90,39),bgBlack:Le(40,49),bgRed:Le(41,49),bgGreen:Le(42,49),bgYellow:Le(43,49),bgBlue:Le(44,49),bgMagenta:Le(45,49),bgCyan:Le(46,49),bgWhite:Le(47,49)}
function Ae(e,t){for(var n,r=0,i="",o="";r<e.length;r++)i+=(n=e[r]).open,o+=n.close,~t.indexOf(n.close)&&(t=t.replace(n.rgx,n.close+n.open))
return i+t+o}function Le(e,t){var n={open:"[".concat(e,"m"),close:"[".concat(t,"m"),rgx:new RegExp("\\x1b\\[".concat(t,"m"),"g")}
return function(t){return void 0!==this&&void 0!==this.has?(~this.has.indexOf(e)||(this.has.push(e),this.keys.push(n)),void 0===t?this:Oe.enabled?Ae(this.keys,t+""):t+""):void 0===t?((r={has:[e],keys:[n]}).reset=Oe.reset.bind(r),r.bold=Oe.bold.bind(r),r.dim=Oe.dim.bind(r),r.italic=Oe.italic.bind(r),r.underline=Oe.underline.bind(r),r.inverse=Oe.inverse.bind(r),r.hidden=Oe.hidden.bind(r),r.strikethrough=Oe.strikethrough.bind(r),r.black=Oe.black.bind(r),r.red=Oe.red.bind(r),r.green=Oe.green.bind(r),r.yellow=Oe.yellow.bind(r),r.blue=Oe.blue.bind(r),r.magenta=Oe.magenta.bind(r),r.cyan=Oe.cyan.bind(r),r.white=Oe.white.bind(r),r.gray=Oe.gray.bind(r),r.grey=Oe.grey.bind(r),r.bgBlack=Oe.bgBlack.bind(r),r.bgRed=Oe.bgRed.bind(r),r.bgGreen=Oe.bgGreen.bind(r),r.bgYellow=Oe.bgYellow.bind(r),r.bgBlue=Oe.bgBlue.bind(r),r.bgMagenta=Oe.bgMagenta.bind(r),r.bgCyan=Oe.bgCyan.bind(r),r.bgWhite=Oe.bgWhite.bind(r),r):Oe.enabled?Ae([n],t+""):t+""
...
break
default:n=e}return n}var De={console:Ie,tap:function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
n+="\n  message: ".concat(He(e.message||"failed")),n+="\n  severity: ".concat(He(t||"failed")),Pe.call(e,"actual")&&(n+="\n  actual  : ".concat(He(e.actual))),Pe.call(e,"expected")&&(n+="\n  expected: ".concat(He(e.expected))),e.stack&&(n+="\n  stack: ".concat(He(e.stack+"\n"))),n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
t+="\n  message: ".concat(He(O(e))),t+="\n  severity: ".concat(He("failed")),e&&e.stack&&(t+="\n  stack: ".concat(He(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}()}
function Fe(e){return function(t){L.globalHooks[e]||(L.globalHooks[e]=[]),L.globalHooks[e].push(t)}}var Be={beforeEach:Fe("beforeEach"),afterEach:Fe("afterEach")}
function Qe(e){L.current?L.current.assert.pushResult({result:!1,message:"global failure: ".concat(O(e)),source:e&&e.stack||V(2)}):(F.globalFailureCount++,L.stats.bad++,L.stats.all++,ne("error",e))}var ze={}
L.currentModule.suiteReport=F
var $e=!1,Ge=!1
function Ye(){Ge=!0,g?g((function(){Je()})):Je()}function We(){L.blocking=!1,fe.advance()}function Je(){if(L.started)We()
...
ne("runStart",F.start(!0)),se("begin",{totalTests:he.count,modules:e}).then(We)}}ze.isLocal=h&&h.location&&"file:"===h.location.protocol,ze.version="2.19.1",q(ze,{config:L,dump:H,equiv:A,reporters:De,hooks:Be,is:R,objectType:I,on:function(e,t){if("string"!=typeof e)throw new TypeError("eventName must be a string when registering a listener")
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,Qe(t),!1},onUncaughtException:Qe,pushFailure:pe,assert:Z.prototype,module:Y,test:ye,todo:ye.todo,skip:ye.skip,only:ye.only,start:function(e){if(L.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=$e
...
if(!L.pageLoaded)return L.autostart=!0,void(v||ze.load())
Ye()},onUnhandledRejection:function(e){w.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),Qe(e)},extend:function(){w.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return q.apply(this,t)},load:function(){L.pageLoaded=!0,q(L,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Ge||(L.blocking=!1,L.autostart&&Ye())},stack:function(e){return V(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
void 0===L.callbacks[i]&&(L.callbacks[i]=[]),e[i]=n(i)}}(ze),function(i){if(h&&v){if(h.QUnit&&h.QUnit.version)throw new Error("QUnit has already been defined.")
h.QUnit=i}e&&e.exports&&(e.exports=i,e.exports.QUnit=i),t&&(t.QUnit=i),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1}(ze),function(){if(h&&v){var e=ze.config,t=Object.prototype.hasOwnProperty
ze.begin((function(){if(!t.call(e,"fixture")){var n=v.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),ze.testStart((function(){if(null!=e.fixture){var t=v.getElementById("qunit-fixture")
...
ze.urlParams=t,ze.config.filter=t.filter,ze.config.module=t.module,ze.config.moduleId=[].concat(t.moduleId||[]),ze.config.testId=[].concat(t.testId||[]),!0===t.seed?ze.config.seed=Math.random().toString(36).slice(2):t.seed&&(ze.config.seed=t.seed),ze.config.urlConfig.push({id:"hidepassed",label:"Hide passed tests",tooltip:"Only show tests and assertions that fail. Stored as query-strings."},{id:"noglobals",label:"Check for Globals",tooltip:"Enabling this will test if any test introduces new properties on the global object (`window` in Browsers). Stored as query-strings."},{id:"notrycatch",label:"No try-catch",tooltip:"Enabling this will run tests outside of a try-catch block. Makes debugging exceptions in IE reasonable. Stored as query-strings."}),ze.begin((function(){for(var e=ze.config.urlConfig,n=0;n<e.length;n++){var r=ze.config.urlConfig[n]
"string"!=typeof r&&(r=r.id),void 0===ze.config[r]&&(ze.config[r]=t[r])}}))}function n(e){return decodeURIComponent(e.replace(/\+/g,"%20"))}}()
var Ve={exports:{}}
!function(e){var t,n
...
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(h&&v){var e=ze.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=N({filter:void 0,module:void 0,moduleId:void 0,testId:void 0}),o=null
ze.on("runStart",(function(e){Ke.defined=e.testCounts.total})),ze.begin((function(t){!function(t){var n,s,a,u,c,f,p,y,E=C("qunit")
E&&(E.setAttribute("role","main"),E.innerHTML="<h1 id='qunit-header'>"+Xe(v.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(n=ze.config.testId)||n.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+Xe(n.join(", "))+" <a id='qunit-clearFilter' href='"+Xe(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(s=C("qunit-header"))&&(s.innerHTML="<a href='"+Xe(i)+"'>"+s.innerHTML+"</a> "),(a=C("qunit-banner"))&&(a.className=""),p=C("qunit-tests"),(y=C("qunit-testresult"))&&y.parentNode.removeChild(y),p&&(p.innerHTML="",(y=v.createElement("p")).id="qunit-testresult",y.className="result",p.parentNode.insertBefore(y,p),y.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',c=C("qunit-testresult-controls")),c&&c.appendChild(((f=v.createElement("button")).id="qunit-abort-tests-button",f.innerHTML="Abort",d(f,"click",T),f)),(u=C("qunit-userAgent"))&&(u.innerHTML="",u.appendChild(v.createTextNode("QUnit "+ze.version+"; "+b.userAgent))),function(t){var n,i,s,a,u,c=C("qunit-testrunner-toolbar")
...
var a=Xe(s.id),u=Xe(s.tooltip)
if(s.value&&"string"!=typeof s.value){if(i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'>"+s.label+": </label><select id='qunit-urlconfig-"+a+"' name='"+a+"' title='"+u+"'><option></option>",Array.isArray(s.value))for(var l=0;l<s.value.length;l++)i+="<option value='"+(a=Xe(s.value[l]))+"'"+(e[s.id]===s.value[l]?(t=!0)&&" selected='selected'":"")+">"+a+"</option>"
else for(var c in s.value)r.call(s.value,c)&&(i+="<option value='"+Xe(c)+"'"+(e[s.id]===c?(t=!0)&&" selected='selected'":"")+">"+Xe(s.value[c])+"</option>")
e[s.id]&&!t&&(i+="<option value='"+(a=Xe(e[s.id]))+"' selected='selected' disabled='disabled'>"+a+"</option>"),i+="</select>"}else i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'><input id='qunit-urlconfig-"+a+"' name='"+a+"' type='checkbox'"+(s.value?" value='"+Xe(s.value)+"'":"")+(e[s.id]?" checked='checked'":"")+" title='"+u+"' />"+Xe(s.label)+"</label>"}return i}(),w(u,"qunit-url-config"),m(u.getElementsByTagName("input"),"change",S),m(u.getElementsByTagName("select"),"change",S),u))
...
o.selectedMap.has(r.moduleId)||(t+=I(r.moduleId,r.name,!1))}return t}(""===e?o.options.slice(0,20).map((function(e){return{obj:e}})):Ze.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(s.value)}))}function S(e){var t=e&&e.target||null
...
p.className="clearfix",c.appendChild(f),c.appendChild(p)}}(t)}(t)})),ze.on("runEnd",(function(t){var n,r,i,o=C("qunit-banner"),s=C("qunit-tests"),a=C("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",_(Ke.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<s.children.length;c++)""!==(n=s.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=v.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!o||a&&!1!==a.disabled||(o.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),s&&(C("qunit-testresult-display").innerHTML=l),e.altertitle&&v.title&&(v.title=["failed"===t.status?"✖":"✔",v.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&h.scrollTo&&h.scrollTo(0,0)})),ze.testStart((function(e){var t,n
R(e.name,e.testId,e.module),(t=C("qunit-testresult-display"))&&(w(t,"running"),n=ze.config.reorder&&e.previousFailure,t.innerHTML=[L(Ke),n?"Rerunning previously failed test: <br />":"Running: ",A(e.name,e.module),_(Ke.failedTests)].join(""))})),ze.log((function(e){var t=C("qunit-test-output-"+e.testId)
if(t){var n,i,o,s=Xe(e.message)||(e.result?"okay":"failed")
s="<span class='test-message'>"+s+"</span>",s+="<span class='runtime'>@ "+e.runtime+" ms</span>"
var a=!1
!e.result&&r.call(e,"expected")?(n=e.negative?"NOT "+ze.dump.parse(e.expected):ze.dump.parse(e.expected),i=ze.dump.parse(e.actual),s+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+Xe(n)+"</pre></td></tr>",i!==n?(s+="<tr class='test-actual'><th>Result: </th><td><pre>"+Xe(i)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(a=!0,o=((o=e.actual-e.expected)>0?"+":"")+o):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(a=P(o=ze.diff(n,i)).length!==P(n).length+P(i).length),a&&(s+="<tr class='test-diff'><th>Diff: </th><td><pre>"+o+"</pre></td></tr>")):-1!==n.indexOf("[object Array]")||-1!==n.indexOf("[object Object]")?s+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+ze.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+Xe(N({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":s+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(s+="<tr class='test-source'><th>Source: </th><td><pre>"+Xe(e.source)+"</pre></td></tr>"),s+="</table>"):!e.result&&e.source&&(s+="<table><tr class='test-source'><th>Source: </th><td><pre>"+Xe(e.source)+"</pre></td></tr></table>")
var u=t.getElementsByTagName("ol")[0],l=v.createElement("li")
l.className=e.result?"pass":"fail",l.innerHTML=s,u.appendChild(l)}})),ze.testDone((function(r){var i=C("qunit-tests"),o=C("qunit-test-output-"+r.testId)
if(i&&o){var s
...
c?w(a,"qunit-collapsed"):(Ke.failedTests.push(r.testId),e.collapse&&(n?w(a,"qunit-collapsed"):n=!0))
var f=o.firstChild,h=l?"<b class='failed'>"+l+"</b>, <b class='passed'>"+u+"</b>, ":""
if(f.innerHTML+=" <b class='counts'>("+h+r.assertions.length+")</b>",Ke.completed++,r.skipped){o.className="skipped"
...
b.innerHTML="<strong>Source: </strong>"+Xe(r.source),w(b,"qunit-source"),c&&w(b,"qunit-collapsed"),d(f,"click",(function(){x(b,"qunit-collapsed")})),o.appendChild(b)}e.hidepassed&&("passed"===s||r.skipped)&&(t.push(o),i.removeChild(o))}})),ze.on("error",(function(e){var t=R("global failure")
if(t){var n=Xe(O(e))
...
a&&p.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),a||"complete"!==v.readyState?d(h,"load",ze.load):ze.load()
var u=h.onerror
...
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),ze.config.queue.length=0,!1}function M(e){var t=C("qunit-filter-input")
...
var o=N(i)
if("hidepassed"===r.name&&"replaceState"in h.history){ze.urlParams[r.name]=n,e[r.name]=n||!1
var s=C("qunit-tests")
...
for(var i in e=q(q({},ze.urlParams),e))if(r.call(e,i)&&void 0!==e[i])for(var o=[].concat(e[i]),s=0;s<o.length;s++)t+=encodeURIComponent(i),!0!==o[s]&&(t+="="+encodeURIComponent(o[s])),t+="&"
return n.protocol+"//"+n.host+n.pathname+t.slice(0,-1)}function j(){var e=C("qunit-filter-input").value
h.location=N({filter:""===e?void 0:e,moduleId:l(o.selectedMap.keys()),module:void 0,testId:void 0})}function I(e,t,n){return'<li><label class="clickable'+(n?" checked":"")+'"><input type="checkbox" value="'+Xe(e)+'"'+(n?' checked="checked"':"")+" />"+Xe(t)+"</label></li>"}function R(e,t,n){var r=C("qunit-tests")
...
return a.className="qunit-assert-list",o.appendChild(a),r.appendChild(o),o}}function _(e){return 0===e.length?"":["<br /><a href='"+Xe(N({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function A(e,t){var n=""
return t&&(n="<span class='module-name'>"+Xe(t)+"</span>: "),n+"<span class='test-name'>"+Xe(e)+"</span>"}function L(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function P(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),ze.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
switch(i){case 1:n[r]="<ins>"+Xe(o)+"</ins>"
break
case t:n[r]="<del>"+Xe(o)+"</del>"
break
case 0:n[r]="<span>"+Xe(o)+"</span>"}}return n.join("")},e.prototype.diffCommonPrefix=function(e,t){var n,r,i,o
